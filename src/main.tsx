    ...
    (payload) => {
      try {
        ...
        if (payload.new && payload.new.data && 
            (payload.new.event_type === "report_update" || payload.new.event === "final_report")) {
          console.log(`[${new Date().toISOString()}] 📝 Report event detected:`, payload.new.event_type || payload.new.event);
