    ...
    <div className="min-h-screen flex flex-col font-sans">
      <header className="py-4 px-6 flex items-center justify-between">
        <div className="flex items-center space-x-2">
          <a href="/" className="no-underline flex items-center">
            ...
            />
            <span className="text-lg font-normal">deep research</span>
          </a>
        </div>
      ...
      <main className="flex-1 max-w-2xl mx-auto px-4 py-16">
        <div className="space-y-6 text-left">
          ...
          <ul className="list-none space-y-3 text-base font-normal pl-4">
          ...
          <p className="text-base font-normal">
            we're working with a selected few to launch their personal deep researchers. if you want us to build your personalized deep research agent, <a href="mailto:tim@timcvetko.com" className="font-normal">drop us a line.</a>
          </p>

          <p className="text-base font-normal">
            you can go ahead and try the raw version right now for <a href="/auth" onClick={(e) => {e.preventDefault(); navigate("/auth");}} className="text-blue-500 hover:underline font-normal">free</a>
          </p>
          
          <div className="pt-4">
            <p className="text-sm font-normal">
              you can reach me via <a href="https://x.com/cvetko_tim" className="font-normal">twitter</a> or email at{" "}
              <span className="font-normal">tim@timcvetko.com</span>.
            </p>
            
            <p className="text-sm pt-1 text-gray-500 font-normal">
              built by tim
            </p>
          </div>
